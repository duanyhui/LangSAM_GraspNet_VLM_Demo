...
sys.path.append(os.path.join(ROOT_DIR, 'graspnet/models'))
sys.path.append(os.path.join(ROOT_DIR, 'graspnet/dataset'))
sys.path.append(os.path.join(ROOT_DIR, 'graspnet/utils'))
...
# ==================== 硬编码配置参数 ====================
CHECKPOINT_PATH = '/home/sd/LangSAM_GraspNet_VLM_Demo/graspnet/logs/log_rs/checkpoint-rs.tar'  # 修改为你的权重路径
NUM_POINT = 10000
NUM_VIEW = 300
...
DEPTH_INTR = {"ppx": 319.178, "ppy": 198.85, "fx": 305.58, "fy": 305.58}
...
if __name__ == '__main__':
    # 示例：使用文件路径
    color_img_path = '/home/sd/LangSAM_GraspNet_VLM_Demo/LangRes/color.png'
    depth_img_path = '/home/sd/LangSAM_GraspNet_VLM_Demo/LangRes/depth.png'
    # sam_mask_path 为 SAM 生成的目标分割掩码，用于过滤不在目标区域内的抓取预测
    sam_mask_path = '/home/sd/LangSAM_GraspNet_VLM_Demo/LangRes/mask.png'
